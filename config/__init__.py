...
API_CONFIG = {
    ...
    "API_KEY": os.getenv(
        "BINANCE_FUTURES_TESTNET_API_KEY", os.getenv("BINANCE_API_KEY", "demo_api_key")
    ),
    "API_SECRET": os.getenv(
        "BINANCE_FUTURES_TESTNET_API_SECRET",
        os.getenv("BINANCE_API_SECRET", "demo_api_secret"),
    ),
    "BINANCE_API_KEY": os.getenv("BINANCE_API_KEY", "demo_api_key"),
    "BINANCE_API_SECRET": os.getenv("BINANCE_API_SECRET", "demo_api_secret"),
    "BINANCE_FUTURES_TESTNET_API_KEY": os.getenv(
        "BINANCE_FUTURES_TESTNET_API_KEY", "demo_api_key"
    ),
    "BINANCE_FUTURES_TESTNET_API_SECRET": os.getenv(
        "BINANCE_FUTURES_TESTNET_API_SECRET", "demo_api_secret"
    ),
}
