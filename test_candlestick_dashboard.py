...
def test_dashboard(stdscr):
    ...
    config = {
        ...
        'open_positions': [
            {'symbol': 'BTCUSDT', 'side': 'LONG', 'size': 0.001902, 'entry_price': 105000, 'current_price': current_price, 'pnl': 15.98}
        ],
        'recent_trades': [
            {'timestamp': '14:03:45', 'symbol': 'BTCUSDT', 'side': 'SELL', 'price': 105173.66, 'quantity': 0.001902}
        ]
    }
    ...
    dashboard.add_log_message("💸 [PAPER TRADE] Executing SELL: 0.001902 BTCUSDT at $105,173.66")
