...
# Added error handling and logging for metrics
try:
    write_metrics_to_results('S&P Broad Crypto Index',  # Renamed to proper capitalization
    ...
    logging.error(f"Failed writing S&P metrics: {str(e)}")
