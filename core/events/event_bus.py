...
class EventBus:
    ...
    def subscribe(self, event_type: str, handler: Union[Callable, EventHandler]) -> None:
        """
    ...
    def unsubscribe(self, event_type: str, handler: Union[Callable, EventHandler]) -> None:
        """
