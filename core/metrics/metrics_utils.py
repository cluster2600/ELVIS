...
def calculate_sortino_ratio(
    ...
    return (
        np.sqrt(annualization_factor) * np.mean(excess_returns) / downside_deviation
...
def calculate_annualized_return(
    returns: np.ndarray, annualization_factor: int = TRADING_DAYS
) -> float:
    """
...
def write_metrics_to_file(
    metrics: Dict[str, float], file_path: str, mode: str = "w"
) -> None:
    """
