...
> `APPLE_NATIVE_CONTAINER_GUIDE.md` and the `apple_container_native.sh` script.
...
### 3. **Start ELVIS**
```bash
./start_elvis_apple.sh   # generated by setup_apple_containers.sh
```
...
- `apple_container_native.sh` — setup/start/stop helper
- `apple_container_elvis.sh`, `test_apple_container.sh`, `fix_apple_container_build.sh` — additional helpers
