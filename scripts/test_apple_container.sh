...
show_recommendations() {
    ...
    echo ""
    echo "✅ Ready to use:"
    echo "   scripts/apple_container_native.sh setup"
    echo "   scripts/apple_container_native.sh start"
    echo ""
    ...
    echo "   scripts/apple_container_native.sh status"
    echo "   scripts/apple_container_native.sh logs"
    echo "   scripts/apple_container_native.sh stop"
    echo ""
