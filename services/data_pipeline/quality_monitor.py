...
class DataQualityMonitor:
    ...
    def update_metrics(self, metrics: Dict):
        ...
        self.metrics_history.append({"timestamp": timestamp, "metrics": metrics})
    ...
    def _check_quality_issues(self, metrics: Dict, timestamp: datetime):
        ...
        # Check error rate
        error_rate = (
            (metrics["error_rate"] / metrics["throughput"]) * 100
        ...
        if issues:
            alert = {"timestamp": timestamp, "issues": issues, "metrics": metrics}
    ...
    def get_quality_report(self) -> Dict:
        ...
        metrics_df = pd.DataFrame([entry["metrics"] for entry in self.metrics_history])
        ...
        return {
            ...
            "statistics": {
                ...
                "error_rate_avg": metrics_df["error_rate"].mean()
                / metrics_df["throughput"].mean()
                * 100,
            },
