...
> ```bash
> COMPOSE_PROFILES=observability ./apple_container_elvis.sh start
> ```
...
- `docker-compose.apple.yml` - Apple Silicon optimizations (generated by `setup_apple_containers.sh`, not checked in)
...
./apple_container_elvis.sh restart
