...
- `Dockerfile.minimal` - Lightweight build used by `docker-compose.yml` (python:3.14-slim)
- `Dockerfile.simple` - Standalone lightweight build used by the setup script
