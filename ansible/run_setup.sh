...
main() {
    ...
    echo ""
    echo "Next steps:"
    echo "1. Configure your .env file with API keys and secrets"
    echo "2. Test the installation: cd .. && python -m pytest tests/"
    echo "3. Start the trading bot: ./run_elvis.sh"
    echo "4. Monitor with Grafana: http://localhost:3000 (admin/admin)"
    echo "5. Check API documentation: http://localhost:5050/api/docs"
}
