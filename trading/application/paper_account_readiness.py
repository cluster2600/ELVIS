...
class PaperAccountReadinessFindingKind(str, Enum):
    ...
    RUNTIME_CONTROL_NOT_LEGACY = "RUNTIME_CONTROL_NOT_LEGACY"
    RUNTIME_GENERATION_MISMATCH = "RUNTIME_GENERATION_MISMATCH"
    OPENING_PROVISIONING_ABSENT = "OPENING_PROVISIONING_ABSENT"
    OPENING_PROVENANCE_MISMATCH = "OPENING_PROVENANCE_MISMATCH"
