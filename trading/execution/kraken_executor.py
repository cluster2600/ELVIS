...
class KrakenExecutor(BaseExecutor):
    ...
    def execute_buy(
        ...
        try:
            ...
            self.logger.info(
                f"Kraken BUY executed: {symbol} {quantity} @ {price or 'market'}"
            )
            return result
    ...
    def execute_sell(
        ...
        try:
            ...
            self.logger.info(
                f"Kraken SELL executed: {symbol} {quantity} @ {price or 'market'}"
            )
            return result
    ...
    def execute_stop_loss(
        ...
        try:
            ...
            self.logger.info(
                f"Kraken STOP LOSS set: {symbol} {quantity} @ {stop_price}"
            )
            return result
    ...
    def execute_take_profit(
        ...
        try:
            ...
            self.logger.info(
                f"Kraken TAKE PROFIT set: {symbol} {quantity} @ {tp_price}"
            )
            return result
    ...
    def get_exchange_info(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "fees": {"trading": {"maker": 0.0016, "taker": 0.0026}},  # 0.16%  # 0.26%
