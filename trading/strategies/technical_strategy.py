...
class TechnicalStrategy(BaseStrategy):
    ...
    def generate_signals(self, data: pd.DataFrame) -> Tuple[bool, bool]:
        ...
        try:
            ...
            buy_signal = bool(
                dx > self.dx_threshold
                and macd > self.macd_threshold
            ...
            sell_signal = bool(
                ...
                or (dx < self.dx_threshold and macd < self.macd_threshold)
            )

            self.logger.info(
                f"Signal Check: RSI={rsi:.2f}, MACD={macd:.2f}, DX={dx:.2f}, OBV={obv:.2f}, Buy={buy_signal}, Sell={sell_signal}"
            )
