...
def test_existing_media_records_are_not_misrepresented_as_public_screenshots() -> None:
    ...
    project_artwork = ROOT / "images" / "elvis.png"
    assert project_artwork.exists()
    assert _sha256(project_artwork) == (
        "e01bfa3c866e701fb2805f99251761dbda2b90345f057ba7cc4083fc08200141"
    )
    readme = _text(ROOT / "README.md")
    assert "generated by the repository owner" in readme
    assert (
        "![ELVIS project artwork generated by the repository owner]"
        "(./images/elvis.png)"
    ) in readme
