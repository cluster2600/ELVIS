...
def test_dashboard_trade_stats():
    ...
    for i, trade in enumerate(recent_trades[:5]):
        ...
        logger.info(f"  {i+1}. {side} {quantity:.4f} {symbol} @ ${price:.2f} | PnL: ${pnl:.2f}")
...
if __name__ == "__main__":
    ...
    if success:
        ...
        logger.info("The console dashboard will now show live trade data instead of static sample data.")
    else:
