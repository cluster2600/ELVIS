...
def test_risk_management_fixes():
    ...
    print(f"✅ Cooldown period: {risk_manager.cooldown_period} seconds (should be 1800)")
...
def test_ensemble_strategy_cooldown():
    ...
    try:
        ...
        assert hasattr(strategy, 'cooldown_period'), "Cooldown period not added to ensemble"
        assert hasattr(strategy, 'last_trade_time'), "Last trade time tracking not added"
