...
def test_dashboard_layout():
    ...
    for width, height, description in terminal_sizes:
        ...
        print(f"   📊 Position: columns {market_depth_x}-{market_depth_x + market_depth_width}, rows {market_depth_y}-{market_depth_y + market_depth_height}")
        ...
        if market_depth_x + market_depth_width <= width and market_depth_height > 0:
            ...
            if market_depth_x + market_depth_width > width:
                print(f"      💡 Need {market_depth_x + market_depth_width - width} more columns")
